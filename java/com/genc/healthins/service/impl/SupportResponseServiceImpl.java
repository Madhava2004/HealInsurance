...
public class SupportResponseServiceImpl implements SupportResponseService {
    ...
    @Override
    public List<SupportResponse> findByTicket(SupportTicket ticket) { 
    	return repo.findBySupportTicket(ticket); 
    }

    @Override
    public SupportResponse findLatestByTicket(SupportTicket ticket) {
        return repo.findTopBySupportTicketOrderByCreatedAtDesc(ticket);
    }
    @Override
    public SupportResponse findTopBySupportTicketOrderByCreatedAtDesc(SupportTicket ticket) {
        return repo.findTopBySupportTicketOrderByCreatedAtDesc(ticket);
    }
}